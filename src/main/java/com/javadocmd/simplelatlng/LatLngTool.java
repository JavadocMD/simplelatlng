 ...
 * this radius which will yield more accurate results. To set the radius used by
 * this library, see {@link com.javadocmd.simplelatlng.util.LatLngConfig}.
 * </p>
 */
public class LatLngTool {
	 ...
	 * rely upon {@link #distance(LatLng, LatLng, LengthUnit)}
	 * </p>
	 * <p>
	 * Yields the internal angle for an arc between two points on the surface of a
	 * sphere in radians. This angle is in the plane of the great circle connecting
	 * the two points measured from an axis through one of the points and the center
	 * of the Earth. Multiply this value by the sphere's radius to get the length of
	 * the arc.
	 * </p>
	 * 
	 * @param point1 the first point.
	...
	/**
	 * <p>
	 * Calculate the initial bearing in degrees on a great-circle course from one
	 * point to another.
	 * </p>
	 * <p>
	 * Remember, you can calculate the final bearing by swapping the start/end
	 * points and reversing the resulting "initial" bearing by adding or subtracting
	 * 180 degrees.
	 * </p>
	 * 
	...
	/**
	 * <p>
	 * Calculate the initial bearing in radians on a great-circle course from one
	 * point to another.
	 * </p>
	 * <p>
	 * Remember, you can calculate the final bearing by swapping the start/end
	...
	/**
	 * <p>
	 * Calculate the end point of traveling along a great-circle path from a given
	 * starting point with a given intitial bearing for a known distance.
	 * </p>
	 * 
	 * @param start          the starting point.
	 * @param initialBearing the initial bearing.
	 * @param distance       the distance to travel.
	 * @param unit           the unit in which distance is measured.
	 ...
	 * @return the normalized latitude. Returns NaN if the input is NaN.
	 */
	 ...
	 * @return the normalized longitude. Returns NaN if the input is NaN, positive
	 ...
	 * @return the normalized bearing. Returns NaN if the input is NaN, positive
	 *         infinity, or negative infinity.
	 */
